"""POST /extract_canvas_v2 endpoint — contract tests with a mocked service."""
...
def test_endpoint_returns_extraction_result_shape() -> None:
    ...
    with patch("app.routers.extract_canvas_v2.extract_canvas_v2", return_value=fake_result):
        resp = client.post(
            "/extract_canvas_v2",
...
def test_endpoint_500_on_service_failure() -> None:
    with patch("app.routers.extract_canvas_v2.extract_canvas_v2",
