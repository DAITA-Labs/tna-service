"""SeasonExtractor — sheet-level metadata: season code/name (e.g. "FW26", "Spring 2026").

Reads `bundle.hint.candidate_kv_blocks["season"]`. Emits one Finding
per sheet.
"""
...
from app.specs import SEASON_SPEC


@component
class SeasonExtractor(Component):
    """Extract `season` Finding from a ClusterAnchorBundle's KvBlocks."""
    ...
    def run(self, bundle: ClusterAnchorBundle) -> dict:
        canonical = SEASON_SPEC.canonical
