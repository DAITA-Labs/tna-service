"""ColorNameExtractor — emits Finding(canonical="color_name") per PLI.

Color name is the descriptive phrase for a color (e.g. "MIDNIGHT BLUE"),
distinct from `color_code` which is the buyer's identifier (e.g. "BLK").
Used only when a sheet has both a code-leaning and a description column.
"""
