"""Registry: canonical → (FieldSpec, strips_attr_name) for IdentifierColumnPicker.
...
PlanAssembler iterates this registry to build one `FieldLocation` per
canonical. Adding a new identifier-shaped canonical = one line here.
"""
